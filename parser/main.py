...
INSTANCE_GROUPS = [
    ...
    InstancesGroupData(name="GotHub", home_url="https://codeberg.org/gothub/gothub", relative_filepath_without_ext="github/gothub",
                       instances=(JSONUsingCallableInstance(relative_filepath_without_ext=Network.CLEARNET, url="https://codeberg.org/NoPlagiarism/gothub-instances/src/branch/master/instances.json", json_handle=lambda raw: tuple(map(lambda inst: get_domain_from_url(inst['link']), raw))), )),
