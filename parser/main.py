...
INSTANCE_GROUPS = [
    InstancesGroupData(name="ProxiTok", home_url="https://github.com/pablouser1/ProxiTok", relative_filepath_without_ext="tiktok/proxitok",
                       instances=(RegexFromUrlInstance(relative_filepath_without_ext=Network.CLEARNET, url="https://raw.githubusercontent.com/wiki/pablouser1/ProxiTok/Public-instances.md", regex_pattern=fr"\|\s+\[(?P<domain>{Regex.DOMAIN})\]\((?P<url>https?:\/\/{Regex.DOMAIN}+)\)\s+(?:\(Official\)\s+)?\|\s+(?P<cloudflare>Yes|No)\s+\|\s+(?P<flagemoji>\S+)\s+\|"),
                                  RegexFromUrlInstance(relative_filepath_without_ext=Network.ONION, url="https://raw.githubusercontent.com/wiki/pablouser1/ProxiTok/Public-instances.md", regex_pattern=fr"\|\s+\[(?P<domain>{Regex.DOMAIN_ONION})\]\((?P<url>https?:\/\/{Regex.DOMAIN_ONION})\)\s+\|"),
                                  RegexFromUrlInstance(relative_filepath_without_ext=Network.I2P, url="https://raw.githubusercontent.com/wiki/pablouser1/ProxiTok/Public-instances.md", regex_pattern=fr"\|\s+\[(?P<domain>{Regex.DOMAIN_I2P})\]\((?P<url>https?:\/\/{Regex.DOMAIN_I2P})\)\s+\|"))),
    ...
    InstancesGroupData(name="LingvaTranslate", home_url="https://github.com/TheDavidDelta/lingva-translate#lingva-translate", relative_filepath_without_ext="translate/lingvatranslate",
                       instances=(RegexFromUrlInstance(relative_filepath_without_ext=Network.CLEARNET, url="https://raw.githubusercontent.com/thedaviddelta/lingva-translate/main/README.md", regex_pattern=fr"\|\s+\[(?P<domain>{Regex.DOMAIN})\]\(https:\/\/{Regex.DOMAIN}\)(?:\s+\(Official\))?\s+\|\s+(?P<hosting>[^\|]+)\s+\|\s+(?P<ssl>[^\|]+)\s+\|"), )),
    InstancesGroupData(name="Whoogle", home_url="https://github.com/benbusby/whoogle-search#readme", relative_filepath_without_ext="search/whoogle",
                       instances=(RegexFromUrlInstance(relative_filepath_without_ext=Network.CLEARNET, url="https://raw.githubusercontent.com/benbusby/whoogle-search/main/README.md", regex_pattern=fr"^\|\s+\[https?:\/\/(?P<domain>{Regex.DOMAIN})\]\((?P<url>https?:\/\/{Regex.DOMAIN})\/?\)\s+\|"),
                                  RegexFromUrlInstance(relative_filepath_without_ext=Network.ONION, url="https://raw.githubusercontent.com/benbusby/whoogle-search/main/README.md", regex_pattern=fr"^\|?\s+\[https?:\/\/(?P<domain>{Regex.DOMAIN_ONION})\]\((?P<url>https?:\/\/{Regex.DOMAIN_ONION})\/?\)\s+\|"),
                                  RegexFromUrlInstance(relative_filepath_without_ext=Network.I2P, url="https://raw.githubusercontent.com/benbusby/whoogle-search/main/README.md", regex_pattern=fr"^\|?\s+\[https?:\/\/(?P<domain>{Regex.DOMAIN_I2P})\]\((?P<url>https?:\/\/{Regex.DOMAIN_I2P})\/?\)\s+\|"))),
    ...
    InstancesGroupData(name="LibreX", home_url="https://github.com/hnhx/librex#readme", relative_filepath_without_ext="search/librex",
                       instances=(RegexFromUrlInstance(relative_filepath_without_ext=Network.CLEARNET, url="https://raw.githubusercontent.com/hnhx/librex/main/README.md", regex_group="clearnet", regex_pattern=fr"\|\s+\[(?P<clearnet>{Regex.DOMAIN})\]\((?P<clearurl>https?:\/\/{Regex.DOMAIN})\)\s+\|\s+(?:❌|(?:\[✅\]\((?:http:\/\/)?(?P<onion>{Regex.DOMAIN_ONION})\/?\)))\s+\|\s+(?:❌|(?:\[✅\]\((?:http:\/\/)?(?P<i2p>{Regex.DOMAIN_I2P})\/?\)))\s+\|\s+(?P<flagemoji>\W+)\s+(?P<country>\w+)\s+(?:\(OFFICIAL\s+INSTANCE\)\s+)?\|"),
                                  RegexFromUrlInstance(relative_filepath_without_ext=Network.ONION, url="https://raw.githubusercontent.com/hnhx/librex/main/README.md", regex_group="onion", regex_pattern=fr"\|\s+\[(?P<clearnet>{Regex.DOMAIN})\]\((?P<clearurl>https?:\/\/{Regex.DOMAIN})\)\s+\|\s+(?:❌|(?:\[✅\]\((?:http:\/\/)?(?P<onion>{Regex.DOMAIN_ONION})\/?\)))\s+\|\s+(?:❌|(?:\[✅\]\((?:http:\/\/)?(?P<i2p>{Regex.DOMAIN_I2P})\/?\)))\s+\|\s+(?P<flagemoji>\W+)\s+(?P<country>\w+)\s+(?:\(OFFICIAL\s+INSTANCE\)\s+)?\|"),
                                  RegexFromUrlInstance(relative_filepath_without_ext=Network.I2P, url="https://raw.githubusercontent.com/hnhx/librex/main/README.md", regex_group="i2p", regex_pattern=fr"\|\s+\[(?P<clearnet>{Regex.DOMAIN})\]\((?P<clearurl>https?:\/\/{Regex.DOMAIN})\)\s+\|\s+(?:❌|(?:\[✅\]\((?:http:\/\/)?(?P<onion>{Regex.DOMAIN_ONION})\/?\)))\s+\|\s+(?:❌|(?:\[✅\]\((?:http:\/\/)?(?P<i2p>{Regex.DOMAIN_I2P})\/?\)))\s+\|\s+(?P<flagemoji>\W+)\s+(?P<country>\w+)\s+(?:\(OFFICIAL\s+INSTANCE\)\s+)?\|"))),
    InstancesGroupData(name="teddit", home_url="https://codeberg.org/teddit/teddit", relative_filepath_without_ext="reddit/teddit",
                       instances=(RegexFromUrlInstance(relative_filepath_without_ext=Network.CLEARNET, url="https://codeberg.org/teddit/teddit/raw/branch/main/README.md", regex_pattern=fr"\|\s+(?:\[(?P<domain>{Regex.DOMAIN})\]\((?P<url>https?:\/\/{Regex.DOMAIN})\)\s+)?\|\s+(?:\[(?:http:\/\/)?[\w\-\.\/\d]+\]\(http:\/\/(?P<onion>{Regex.DOMAIN_ONION})\/?\)\s+)?\|\s+(?:\[(?:http:\/\/)?[\w\-\.\/\d]+\]\(http:\/\/(?P<i2p>{Regex.DOMAIN_I2P})\/?\)\s+)?\|\s+(?P<notes>(?:[^\|])+)?\|"),
                                  RegexFromUrlInstance(relative_filepath_without_ext=Network.ONION, url="https://codeberg.org/teddit/teddit/raw/branch/main/README.md", regex_group="onion", regex_pattern=fr"\|\s+(?:\[(?P<domain>{Regex.DOMAIN})\]\((?P<url>https?:\/\/{Regex.DOMAIN})\)\s+)?\|\s+(?:\[(?:http:\/\/)?[\w\-\.\/\d]+\]\(http:\/\/(?P<onion>{Regex.DOMAIN_ONION})\/?\)\s+)?\|\s+(?:\[(?:http:\/\/)?[\w\-\.\/\d]+\]\(http:\/\/(?P<i2p>{Regex.DOMAIN_I2P})\/?\)\s+)?\|\s+(?P<notes>(?:[^\|])+)?\|"),
                                  RegexFromUrlInstance(relative_filepath_without_ext=Network.I2P, url="https://codeberg.org/teddit/teddit/raw/branch/main/README.md", regex_group="i2p", regex_pattern=fr"\|\s+(?:\[(?P<domain>{Regex.DOMAIN})\]\((?P<url>https?:\/\/{Regex.DOMAIN})\)\s+)?\|\s+(?:\[(?:http:\/\/)?[\w\-\.\/\d]+\]\(http:\/\/(?P<onion>{Regex.DOMAIN_ONION})\/?\)\s+)?\|\s+(?:\[(?:http:\/\/)?[\w\-\.\/\d]+\]\(http:\/\/(?P<i2p>{Regex.DOMAIN_I2P})\/?\)\s+)?\|\s+(?P<notes>(?:[^\|])+)?\|"))),
    ...
    InstancesGroupData(name="Quetre", home_url="https://github.com/zyachel/quetre#readme", relative_filepath_without_ext="quora/quetre",
                       instances=(RegexCroppedFromUrlInstance(relative_filepath_without_ext=Network.CLEARNET, crop_from="1. Clearnet", crop_to="2. Onion", url="https://raw.githubusercontent.com/zyachel/quetre/main/README.md", regex_pattern=fr"\|\s+\[(https?:\/\/)?(?P<domain>{Regex.DOMAIN})]\(https?:\/\/{Regex.DOMAIN}\)\s+\|\s+(?P<region>[^\|]+)\|\s+(?P<provider>[^\|]+)\s+\|\s+(?P<note>[^\|]+)\s+\|"),
                                  ...
                                  RegexCroppedFromUrlInstance(relative_filepath_without_ext=Network.I2P, crop_from="3. I2P", crop_to="---", url="https://raw.githubusercontent.com/zyachel/quetre/main/README.md", regex_pattern=fr"\|\s+\[(https?:\/\/)?(?P<domain>{Regex.DOMAIN_I2P})]\(https?:\/\/{Regex.DOMAIN_I2P}\)\s+\|\s+(?P<region>[^\|]+)\|\s+(?P<provider>[^\|]+)\s+\|\s+(?P<note>[^\|]+)\s+\|"))),
    ...
    InstancesGroupData(name="libmedium", home_url="https://git.batsense.net/realaravinth/libmedium", relative_filepath_without_ext="medium/libmedium",
                       instances=(RegexCroppedFromUrlInstance(relative_filepath_without_ext=Network.CLEARNET, url="https://git.batsense.net/realaravinth/libmedium/raw/branch/master/README.md", crop_from="## Instances", crop_to="##", regex_pattern=fr"\|\s+https:\/\/(?P<domain>{Regex.DOMAIN})\/?\s+\|\s+(?P<country>(?:[^\|])+)\s+\|\s+(?P<provider>(?:[^\|])+)\s+\|\s+(?P<host>(?:[^\|])+)\|?"),
    ...
    InstancesGroupData(name="libremdb", home_url="https://github.com/zyachel/libremdb", relative_filepath_without_ext="imdb/libremdb",
                       instances=(RegexCroppedFromUrlInstance(relative_filepath_without_ext=Network.CLEARNET, url="https://raw.githubusercontent.com/zyachel/libremdb/main/README.md", crop_from="## Instances", crop_to="##", regex_pattern=fr"\|\s+\[(?P<domain>{Regex.DOMAIN})\]\(https:\/\/{Regex.DOMAIN}\)\s+\|(?P<country>(?:[^\|])+)\s+\|\s+(?P<notes>(?:[^\|])+)\|"),
                                  RegexCroppedFromUrlInstance(relative_filepath_without_ext=Network.ONION, url="https://raw.githubusercontent.com/zyachel/libremdb/main/README.md", crop_from="## Instances", crop_to="##", regex_pattern=fr"\|\s+\[(?P<domain>{Regex.DOMAIN_ONION})\]\(http:\/\/{Regex.DOMAIN}\)\s+\|(?P<country>(?:[^\|])+)\s+\|\s+(?P<notes>(?:[^\|])+)\|"),
                                  RegexCroppedFromUrlInstance(relative_filepath_without_ext=Network.I2P, url="https://raw.githubusercontent.com/zyachel/libremdb/main/README.md", crop_from="## Instances", crop_to="##", regex_pattern=fr"\|\s+\[(?P<domain>{Regex.DOMAIN_I2P})\]\(http:\/\/{Regex.DOMAIN}\)\s+\|(?P<country>(?:[^\|])+)\s+\|\s+(?P<notes>(?:[^\|])+)\|"))),
    InstancesGroupData(name="AnonymousOverflow", home_url="https://github.com/httpjamesm/AnonymousOverflow#readme", relative_filepath_without_ext="stackoverflow/anonymousoverflow",
                       instances=(RegexFromUrlInstance(relative_filepath_without_ext=Network.CLEARNET, url="https://raw.githubusercontent.com/httpjamesm/AnonymousOverflow/main/README.md", regex_pattern=fr"\|\s+\[(?P<domain>{Regex.DOMAIN}(?:[^(?:.i2p)|(?:.onion)]))\]\(https?:\/\/{Regex.DOMAIN}\/?\)\s+\|(?P<country>(?:[^\|])+)\s+\|\s+(?P<notes>(?:[^\|])+)\|"),
                                  RegexFromUrlInstance(relative_filepath_without_ext=Network.ONION, url="https://raw.githubusercontent.com/httpjamesm/AnonymousOverflow/main/README.md", regex_pattern=fr"\|\s+\[(?P<domain>{Regex.DOMAIN_ONION})\]\(https?:\/\/{Regex.DOMAIN}\/?\)\s+\|(?P<country>(?:[^\|])+)\s+\|\s+(?P<notes>(?:[^\|])+)\|"),
                                  RegexFromUrlInstance(relative_filepath_without_ext=Network.I2P, url="https://raw.githubusercontent.com/httpjamesm/AnonymousOverflow/main/README.md", regex_pattern=fr"\|\s+\[(?P<domain>{Regex.DOMAIN_I2P})\]\(https?:\/\/{Regex.DOMAIN}\/?\)\s+\|(?P<country>(?:[^\|])+)\s+\|\s+(?P<notes>(?:[^\|])+)\|"))),
